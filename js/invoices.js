...
// Grouped by party first, so every invoice to the same customer sits
// together (instead of interleaved by whoever billed that day) — within a
// party, oldest → newest by date; tie-break on invoice number.
function _invByPartyThenDate(a, b) {
      ...
      : (() => {
          ...
          <div class="card-body" style="padding:0">
            <div class="orders-table">
              ...
              ${(() => {
                const sorted = filtered.slice().sort(_invByPartyThenDate);
                let prevParty = null;
                ...
                // New party group — a visible break so same-party rows read as clustered
                const newGroup = inv.party !== prevParty;
                prevParty = inv.party;
                return `
